"""
Random Forest classifier trained on CICDDoS2019.
...
OUTPUT_DIR   = Path("models/artifacts_ddos2019/random_forest")
RANDOM_STATE = 42
TEST_SIZE    = 0.20
...
def main():
    ...
    top10 = sorted(metrics["feature_importances"].items(), key=lambda x: x[1], reverse=True)[:10]
